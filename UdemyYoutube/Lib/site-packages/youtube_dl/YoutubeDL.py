...
class YoutubeDL(object):
    ...
    def __init__(self, params=None, auto_init=True):
        ...
        check_deprecated('autonumber_size', '--autonumber-size', 'output templates with %(autonumber)0Nd, where N in the number of digits')
    ...
    def prepare_filename(self, info_dict):
        ...
        try:
            ...
            # templates for missing fields to meet string presentation type.
            ...
            self.report_error('Error in output templates: ' + str(err) + ' (encoding: ' + repr(preferredencoding()) + ')')
            return None
